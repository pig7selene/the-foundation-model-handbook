...
The mechanisms of Chapters 23--28 should be chosen from an observed bottleneck, not stacked by default. @tab-optimization-levers summarizes their primary pressure and the condition that can reverse their apparent benefit.
