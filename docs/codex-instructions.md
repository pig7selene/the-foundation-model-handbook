...
These instructions govern every new standalone chapter in this repository. Chapters 1–23, `docs/style-guide.md`, `docs/chapter-template.md`, and the shared Typst files are the project baseline. Do not begin a new chapter by copying generic Foundation Model prose or by inventing a separate visual style.
